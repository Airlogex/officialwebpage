    ...
    <footer className="bg-gray-800 text-white py-8 px-4 md:px-16">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div className="footer-section">
          <h3 className="text-2xl font-bold mb-4  text-red-700" id="footerBrand">AirLogex</h3>
        ...
        <div className="footer-section">
          <h3 className="text-xl font-semibold mb-4  text-red-700" id="quickLinksTitle">Quick Links</h3>
          <ul>
        ...
        <div className="footer-section">
          <h3 className="text-xl font-semibold mb-4  text-red-700" id="servicesTitle">Services</h3>
          <ul>
        ...
        <div className="footer-section">
          <h3 className="text-xl text-red-700 font-semibold mb-4" id="contactTitle">Contact Info</h3>
          <ul>
